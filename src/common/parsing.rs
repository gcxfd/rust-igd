...
pub fn parse_add_any_port_mapping_response(result: RequestResult) -> Result<u16, AddAnyPortError> {
  match result {
    Ok(resp) => {
      ...
      {
        Some(port) => Ok(port),
        None => Err(AddAnyPortError::RequestError(
          RequestError::InvalidResponse(resp.text),
        )),
      }
    }
...
pub fn parse_get_generic_port_mapping_entry(
  ...
  let make_err = |msg: String| {
    || GetGenericPortMappingEntryError::RequestError(RequestError::InvalidResponse(msg))
  };
...
fn test_parse_device2() {
        ...
        <device>
            ...
            <serviceList>
                <service>
                    ...
                    <controlURL>/igd_async_stdupnp/control/any</controlURL>
                    <eventSubURL>/igd_async_stdupnp/control/any</eventSubURL>
                ...
                <device>
                    ...
                    <serviceList>
                        <service>
                            <serviceType>urn:schemas-upnp-org:service:WANCommonInterfaceConfig:1</serviceType>
                            <serviceId>urn:upnp-org:serviceId:WANCommonIFC1</serviceId>
                            <controlURL>/igd_async_stdupnp/control/WANCommonIFC1</controlURL>
                            <eventSubURL>/igd_async_stdupnp/control/WANCommonIFC1</eventSubURL>
                            <SCPDURL>/igd_async_stdicfgSCPD.xml</SCPDURL>
                        </service>
                    </serviceList>
                    <deviceList>
                        <device>
                            ...
                            <serviceList>
                                <service>
                                    ...
                                    <controlURL>/igd_async_stdupnp/control/WANDSLLinkC1</controlURL>
                                    <eventSubURL>/igd_async_stdupnp/control/WANDSLLinkC1</eventSubURL>
                                    <SCPDURL>/igd_async_stddslSCPD.xml</SCPDURL>
                                </service>
                                <service>
                                    <serviceType>urn:schemas-upnp-org:service:WANIPConnection:1</serviceType>
                                    <serviceId>urn:upnp-org:serviceId:WANIPConn1</serviceId>
                                    <controlURL>/igd_async_stdupnp/control/WANIPConn1</controlURL>
                                    <eventSubURL>/igd_async_stdupnp/control/WANIPConn1</eventSubURL>
                                    <SCPDURL>/igd_async_stdconnSCPD.xml</SCPDURL>
                                </service>
                                <service>
                                    <serviceType>urn:schemas-upnp-org:service:WANIPv6FirewallControl:1</serviceType>
                                    <serviceId>urn:upnp-org:serviceId:WANIPv6Firewall1</serviceId>
                                    <controlURL>/igd_async_std2upnp/control/WANIPv6Firewall1</controlURL>
                                    <eventSubURL>/igd_async_std2upnp/control/WANIPv6Firewall1</eventSubURL>
                                    <SCPDURL>/igd_async_std2ipv6fwcSCPD.xml</SCPDURL>
                                </service>
                            </serviceList>
                        </device>
                    </deviceList>
  ...
  assert_eq!(control_url, "/igd_async_stdupnp/control/WANIPConn1");
  assert_eq!(control_schema_url, "/igd_async_stdconnSCPD.xml");
}
